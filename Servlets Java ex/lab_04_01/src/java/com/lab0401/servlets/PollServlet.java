 ...
 * @author khali
 */
@WebServlet(name = "PollServlet", urlPatterns = {"/servlet"})
public class PollServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Integer voteCount = votes.get("color");
            if (voteCount == null){
            voteCount=0;
            }
            voteCount++;
            ...
            out.println("</li>" + "<li>" + vote.getKey() + ":" + vote.getValue());
            }
        }
    }
